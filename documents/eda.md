...
11. Summary statistics of 'revenue' and 'budget': Summary statistics (such as mean, median, minimum, and maximum) are calculated for the 'revenue' and 
   'budget' attributes.
...
13. Relationship between 'runtime' and 'vote_average': A scatter plot with a regression line and correlation coefficient is generated to analyze the relationship
    between the runtime of the movies and the average votes they receive.
